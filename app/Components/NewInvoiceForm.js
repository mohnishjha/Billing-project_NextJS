...
const NewInvoiceForm = () => {
  ...
  const handleSubmitOriginal = () => {
    ...
    //generate new invoiceid everytime a user submits so that each invoice has uniqueid
    // const generateInvoiceID = () => {
    //   let idNum = 0
    //   let id = newInput.tName[0] + newInput.fCity[0] + newInput.tCountry[0] + idNum++
    //   console.log(id)
    // }
      ...
      >
        ...
        <div className="flex justify-around mt-5 mb-5 ml-6">
          ...
          <div className="w-28 h-12 rounded-3xl bg-[#373b53]">
            <button className="h-12 w-28 text-xs font-bold text-[#888eb0]">
              Save as Draft
            </button>
          </div>
